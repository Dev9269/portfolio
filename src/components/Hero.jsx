...
export default function Hero() {
  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden px-5 pb-20 pt-28 sm:px-8" aria-labelledby="hero-title">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-12 md:grid-cols-[1.1fr_0.9fr] lg:grid-cols-[1.05fr_0.95fr]">
        <motion.div
        ...
        >
          ...
          <h1 id="hero-title" className="max-w-4xl text-6xl font-semibold tracking-[-0.08em] text-white sm:text-7xl lg:text-8xl">
            {profile.name}
          </h1>

          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.28 }} className="mt-8 max-w-2xl text-xl leading-8 text-text-secondary sm:text-2xl">
            {profile.tagline}
          </motion.p>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="mt-10 flex flex-wrap gap-4">
            <motion.div whileHover={{ y: -2 }}>
              <Link
                to="/projects"
                className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 font-semibold text-black shadow-[0_0_40px_rgba(255,255,255,0.18)] transition hover:bg-text-primary"
              >
            ...
            <motion.a
              href={profile.resume}
              whileHover={{ y: -2 }}
              className="inline-flex items-center gap-2 rounded-full border border-white/15 px-6 py-3 font-semibold text-white transition hover:border-accent hover:bg-white/5"
            >
            ...
            <motion.div whileHover={{ y: -2 }}>
              <Link
                to="/contact"
                className="inline-flex items-center rounded-full border border-white/15 px-6 py-3 font-semibold text-white transition hover:border-accent hover:bg-white/5"
              >
                Contact Me
              </Link>
            </motion.div>
        ...
        <motion.div className="relative mx-auto aspect-square w-full max-w-[560px]" initial={{ opacity: 0, scale: 0.92 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.25, duration: 1 }}>
          <GlobeCanvas />
          <motion.div
            ...
            className="absolute bottom-4 right-0 w-[min(92%,360px)] rounded-[2rem] border border-white/15 bg-white/[0.075] p-5 shadow-[0_30px_100px_rgba(0,0,0,0.55)] backdrop-blur-2xl"
          >
